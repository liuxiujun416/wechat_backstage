...
<head>
    ...
    <link href="{{URL::asset('blog/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" media="all" />
    <!-- //pop-up -->
    <link href="{{URL::asset('blog/owl-carousel/owl.carousel.css')}}" rel='stylesheet' type='text/css'/>
    <link rel="stylesheet" type="text/css" href="{{URL::asset('blog/css/style.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{URL::asset('blog/font-awesome-4.4.0/css/font-awesome.min.css')}}" />

    <script type="text/javascript" src="{{URL::asset('blog/js/html5shiv.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('blog/js/respond.min.js')}}"></script>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a class="page-scroll" href="{{URL('blog/index')}}">Home</a>
                </li>
                <li>
                    <a class="page-scroll" href="{{URL('blog/archive')}}">Blog</a>
                </li>
                <li>
                    <a class="page-scroll" href="{{URL('blog/single')}}">About</a>
                </li>
                <li>
                    <a class="page-scroll" href="{{URL('blog/contact')}}">Contact</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
